DROP DATABASE bot_asistencia;

CREATE DATABASE bot_asistencia;
...
CREATE USER 'kuorra'@'localhost' IDENTIFIED BY 'kuorra.2017';
GRANT ALL PRIVILEGES ON bot_asistencia.* TO 'kuorra'@'localhost';
FLUSH PRIVILEGES;
